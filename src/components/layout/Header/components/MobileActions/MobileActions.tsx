    ...
    <div className="flex items-center gap-3">
      ...
      <button 
        ...
        className={cn(
          ...
          isCompareOpen && "bg-[#EBFCF4] border-[#0B6333] text-[#0B6333]"
        )}
        title="Compare Items"
      >
        ...
        <span className="absolute -top-1 -right-1 bg-[#1D77BD] text-white rounded-full w-4 h-4 flex items-center justify-center text-[10px] font-semibold border border-white">2</span>
        {isCompareOpen && (
          <span className="absolute -top-1 -right-1 bg-[#0B6333] text-white rounded-full w-4 h-4 flex items-center justify-center text-[10px] font-semibold border border-white">
            ON
          </span>
        )}
      </button>
      ...
      <button 
        ...
        className="relative w-10 h-10 border border-[#e9ecef] bg-white rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 text-[#4A4A4A] hover:bg-[#EBFCF4] hover:border-[#0B6333] hover:opacity-90"
        title="Notifications"
      >
        ...
        <span className="absolute -top-1 -right-1 bg-[#e74c3c] text-white rounded-full w-4 h-4 flex items-center justify-center text-[10px] font-semibold border border-white">5</span>
      </button>
      ...
      >
        ...
        <span className="absolute -top-1 -right-1 bg-[#1D77BD] text-white rounded-full w-4 h-4 flex items-center justify-center text-[10px] font-semibold border border-white">3</span>
        {isCartOpen && (
          <span className="absolute -top-1 -right-1 bg-[#0B6333] text-white rounded-full w-4 h-4 flex items-center justify-center text-[10px] font-semibold border border-white">
            ON
          </span>
