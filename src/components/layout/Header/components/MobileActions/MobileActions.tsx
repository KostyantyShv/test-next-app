  ...
  return (
    <div className="flex items-center gap-3">
      ...
      >
        ...
        <span className="absolute -top-1 -right-1 bg-[var(--verification-blue)] text-white rounded-full w-4 h-4 flex items-center justify-center text-[10px] font-semibold border border-[var(--surface-color)]">2</span>
        {isCompareOpen && (
          <span className="absolute -top-1 -right-1 bg-[var(--active-green)] text-white rounded-full w-4 h-4 flex items-center justify-center text-[10px] font-semibold border border-[var(--surface-color)]">
            ON
          </span>
        )}
      </button>
      ...
      <button 
        ...
        title="Notifications"
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-4 h-4 fill-black dark:fill-white">
        ...
        <span className="absolute -top-1 -right-1 bg-[var(--state-error-text)] text-white rounded-full w-4 h-4 flex items-center justify-center text-[10px] font-semibold border border-[var(--surface-color)]">5</span>
      </button>
      ...
      >
        ...
        <span className="absolute -top-1 -right-1 bg-[var(--verification-blue)] text-white rounded-full w-4 h-4 flex items-center justify-center text-[10px] font-semibold border border-[var(--surface-color)]">3</span>
        {isCartOpen && (
          <span className="absolute -top-1 -right-1 bg-[var(--active-green)] text-white rounded-full w-4 h-4 flex items-center justify-center text-[10px] font-semibold border border-[var(--surface-color)]">
            ON
          </span>
      ...
      <button 
        ...
        title="Toggle Theme"
      >
        <svg fill="none" viewBox="0 0 20 20" className="fill-background w-4 h-4">
      ...
      <Avatar 
        size="sm"
        className="border border-[var(--border-color)] hover:border-[var(--active-green)]"
      />
