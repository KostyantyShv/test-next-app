    ...
    <div className="header-actions flex items-center gap-4">
      ...
      <button 
        ...
        className={cn(
          ...
          isCompareOpen && "bg-[var(--apply-button-bg)] border-[var(--active-green)] text-[var(--active-green)]"
        )}
        title="Compare Items"
      >
        ...
        <span className="header-action-badge absolute -top-1.5 -right-1.5 bg-[var(--verification-blue)] text-white rounded-full w-5 h-5 flex items-center justify-center text-[11px] font-semibold border-2 border-[var(--surface-color)]">2</span>
        {isCompareOpen && (
          <span className="header-action-badge-on absolute -top-1.5 -right-1.5 bg-[var(--active-green)] text-white rounded-full w-5 h-5 flex items-center justify-center text-[11px] font-semibold border-2 border-[var(--surface-color)]">
            ON
          </span>
        )}
      </button>
      ...
      <button 
        ...
        className={cn(
          "header-action-btn relative w-11 h-11 border border-[var(--border-color)] bg-[var(--surface-color)] rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 text-[var(--text-default)] hover:bg-[var(--apply-button-bg)] hover:border-[var(--active-green)] hover:opacity-90",
          isMonitorOpen && "bg-[var(--apply-button-bg)] border-[var(--active-green)] text-[var(--active-green)]"
        )}
      ...
      >
        ...
        <span className="header-action-badge absolute -top-1.5 -right-1.5 bg-[var(--verification-blue)] text-white rounded-full w-5 h-5 flex items-center justify-center text-[11px] font-semibold border-2 border-[var(--surface-color)]">5</span>
        {isMonitorOpen && (
          <span className="header-action-badge-on absolute -top-1.5 -right-1.5 bg-[var(--active-green)] text-white rounded-full w-5 h-5 flex items-center justify-center text-[11px] font-semibold border-2 border-[var(--surface-color)]">
            ON
          </span>
      ...
      <button 
        ...
        title="Notifications"
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 text-[var(--text-default)]">
        ...
        <span className="header-action-badge absolute -top-1.5 -right-1.5 bg-[var(--state-error-text)] text-white rounded-full w-5 h-5 flex items-center justify-center text-[11px] font-semibold border-2 border-[var(--surface-color)]">5</span>
      </button>
      ...
      <button 
        ...
        className={cn(
          "header-action-btn header-cart-btn relative w-11 h-11 border border-[var(--border-color)] bg-[var(--surface-color)] rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 text-[var(--text-default)] hover:bg-[var(--apply-button-bg)] hover:border-[var(--active-green)] hover:opacity-90",
          isCartOpen && "bg-[var(--apply-button-bg)] border-[var(--active-green)] text-[var(--active-green)]"
        )}
        title="Shopping Cart"
      >
        ...
        <span className="header-action-badge absolute -top-1.5 -right-1.5 bg-[var(--verification-blue)] text-white rounded-full w-5 h-5 flex items-center justify-center text-[11px] font-semibold border-2 border-[var(--surface-color)]">3</span>
        {isCartOpen && (
          <span className="header-action-badge-on absolute -top-1.5 -right-1.5 bg-[var(--active-green)] text-white rounded-full w-5 h-5 flex items-center justify-center text-[11px] font-semibold border-2 border-[var(--surface-color)]">
            ON
          </span>
      ...
      <button 
        ...
        title="Toggle Theme"
      >
        <svg fill="none" viewBox="0 0 20 20" className="w-5 h-5 text-[var(--text-default)]">
          <g clipPath="url(#clip0_1607_78670)">
            ...
            <path strokeLinejoin="round" strokeLinecap="round" strokeWidth="1.6" stroke="currentColor" d="M15.8333 9.16634H17.4999M16.6666 8.33301V9.99967"></path>
          </g>
          <defs>
      ...
      <button 
        ...
        className={cn(
          "header-action-btn relative w-11 h-11 border border-[var(--border-color)] bg-[var(--surface-color)] rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 text-[var(--text-default)] hover:bg-[var(--apply-button-bg)] hover:border-[var(--active-green)] hover:opacity-90",
          isAIPanelOpen && "bg-[var(--apply-button-bg)] border-[var(--active-green)] text-[var(--active-green)]"
        )}
      ...
      <Avatar 
        size="md"
        className="header-avatar border border-[var(--border-color)] hover:border-[var(--active-green)]"
      />
