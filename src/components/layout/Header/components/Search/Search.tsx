...
export const Search: FC = () => {
  ...
  return (
    <div className="relative" ref={searchRef}>
      {/* Search Wrapper */}
      <div className={cn(
        "flex items-stretch w-full max-w-[800px] h-[52px] bg-[#E1E7EE] border border-[#c7c7c7] rounded-[6px] shadow-[0_1px_2px_rgba(0,0,0,0.04)] overflow-hidden transition-all duration-300",
        isFocused && "border-[#016853] shadow-[0_0_0_4px_rgba(0,158,203,0.03)]"
      )}>
        {/* Search Icon */}
          ...
          <svg viewBox="0 0 24 24" className="w-5 h-5 opacity-70">
            <defs>
              <radialGradient id="circleGradient" cx="30%" cy="30%" r="70%" fx="20%" fy="20%">
                <stop offset="0%" style={{stopColor: '#FFE4D6'}}></stop>
                <stop offset="45%" style={{stopColor: '#9EC5E3'}}></stop>
                <stop offset="100%" style={{stopColor: '#386087'}}></stop>
              </radialGradient>
              <linearGradient id="handleGradient" x1="0%" y1="100%" x2="0%" y2="0%">
                <stop offset="0%" style={{stopColor: '#386087'}}></stop>
                <stop offset="100%" style={{stopColor: '#9EC5E3'}}></stop>
              </linearGradient>
            </defs>
            <path opacity="0.9" fillRule="nonzero" fill="url(#handleGradient)" d="M14.2928932,16.7071068 C13.9023689,16.3165825 13.9023689,15.6834175 14.2928932,15.2928932 C14.6834175,14.9023689 15.3165825,14.9023689 15.7071068,15.2928932 L19.7071068,19.2928932 C20.0976311,19.6834175 20.0976311,20.3165825 19.7071068,20.7071068 C19.3165825,21.0976311 18.6834175,21.0976311 18.2928932,20.7071068 L14.2928932,16.7071068 Z"></path>
            <path fillRule="nonzero" fill="url(#circleGradient)" d="M11,16 C13.7614237,16 16,13.7614237 16,11 C16,8.23857625 13.7614237,6 11,6 C8.23857625,6 6,8.23857625 6,11 C6,13.7614237 8.23857625,16 11,16 Z M11,18 C7.13400675,18 4,14.8659932 4,11 C4,7.13400675 7.13400675,4 11,4 C14.8659932,4 18,7.13400675 18,11 C18,14.8659932 14.8659932,18 11,18 Z"></path>
          </svg>
        </div>
        ...
        {searchValue && (
          ...
          >
            <svg viewBox="0 0 24 24" className="w-4 h-4 fill-[#5F5F5F] block">
        ...
        <div className="relative flex items-center gap-2 px-5 text-[#4A4A4A] bg-white cursor-pointer whitespace-nowrap transition-all duration-300 before:content-[''] before:absolute before:left-0 before:top-0 before:bottom-0 before:w-[10px] before:bg-white before:rounded-[10px] before:transform before:-translate-x-[50%]">
          ...
          <span>All</span>
          <svg className="w-3 h-3" viewBox="0 0 10 16" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M1 5L5 1L9 5" />
      ...
      {/* Search Suggestions */}
      {showSuggestions && (
        <div className="absolute top-[calc(100%+12px)] left-0 right-0 bg-white border border-[#e9ecef] rounded-[12px] shadow-[0_8px_32px_rgba(0,0,0,0.15)] opacity-100 visible transform translate-y-0 transition-all duration-300 z-[1000] max-h-[600px] overflow-y-auto p-4">
          {/* Trending Section */}
          <div className="mb-6">
            ...
            <div className="flex flex-col gap-1">
              {trendingSearches.map((search, index) => (
                <div key={index} className="flex items-center gap-3 px-4 py-3 rounded-lg cursor-pointer transition-all duration-300 hover:bg-[#f8f9fa]">
                  <svg fill="currentColor" className="shrink-0 h-5 w-5 text-[#009ECB]" viewBox="0 -960 960 960">
          ...
          <div className="mt-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-8 h-8 bg-[#f8f9fa] rounded-full flex items-center justify-center">
                <svg className="w-4 h-4 text-[#009ECB]" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none">
            ...
            <div className="flex flex-wrap gap-3">
              {topics.map((topic, index) => (
                <div key={index} className="inline-flex items-center justify-between px-3 py-1.5 bg-[#EBFCF4] border border-[#009ECB] rounded-lg min-w-[120px] max-w-fit gap-2 text-sm text-[#4A4A4A] transition-all duration-300 cursor-pointer hover:bg-[#D7F7E9]">
                  <span className="font-[450] tracking-[-0.01em]">{topic}</span>
                  <div className="w-[18px] h-[18px] bg-[#009ECB] rounded-full flex items-center justify-center">
