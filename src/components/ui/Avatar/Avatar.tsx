        ...
        >
          ...
          <div className="py-2 border-t border-[#DFDDDB]" style={{ padding: '8px 0' }}>
            ...
            >
              ...
              <span className="text-sm font-normal text-left" style={{ fontSize: '14px', fontWeight: 400, lineHeight: 1.4 }}>Support</span>
            </button>
          ...
          {/* Logout Section */}
          <div className="border-t border-[#DFDDDB] pt-2 mt-2">
            <button 
              onClick={handleLogout}
              className="logout-item menu-item flex items-center w-full px-4 py-2 text-[#4A4A4A] hover:bg-[#E1E7EE] transition-all duration-200 group"
            >
          ...
          {/* Footer Section */}
          <div className="bg-[#E1E7EE] p-4 border-t border-[#DFDDDB]">
            <style jsx>{`
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex gap-4">
                <a href="#" className="platform-link flex items-center gap-1 text-[#5F5F5F] hover:text-[#016853] transition-colors" style={{ fontSize: '13px' }}>
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex gap-3">
                <a href="#" className="social-link w-7 h-7 bg-[#DFDDDB] hover:bg-[#D7F7E9] text-[#5F5F5F] hover:text-[#016853] rounded-md flex items-center justify-center transition-all duration-200">
