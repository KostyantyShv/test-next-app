        ...
        <div className="flex items-center gap-3">
          ...
          <div className={`relative ${isSearchActive ? 'flex' : 'hidden'} items-center gap-3`}>
            ...
            <div className="flex items-center bg-white border border-[rgba(0,0,0,0.1)] rounded h-10 w-[350px] flex-shrink-0">
              <div className="text-sm font-semibold text-[#d0d0d0] px-3  flex-shrink-0">Where</div>
              <div className="flex items-center relative flex-1 h-full min-w-0">
                <input
                  type="text"
                ...
                <button 
                  ...
                  className={`w-5 h-5 flex items-center justify-center text-[#5F5F5F] opacity-70 hover:opacity-100 transition-opacity flex-shrink-0 ${searchQuery ? 'flex' : 'hidden'}`}
                >
