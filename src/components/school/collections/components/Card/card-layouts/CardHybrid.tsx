  ...
  return (
    <div>
      <div className="school-card flex p-5 border border-gray-200/50 rounded-xl transition-all duration-200 ease-in-out hover:-translate-y-0.5 hover:shadow-[0_4px_20px_rgba(0,0,0,0.12)] hover:border-green-600/20 relative overflow-visible z-[1]">
        <div
          className={`image-container flex flex-col w-[60px] mr-5 flex-shrink-0 ${
        ...
        >
          <Image
            ...
            width={60}
            height={60}
            className={`school-image rounded-lg object-cover ${
              school.specialty ? "rounded-b-none" : ""
            }`}
          />
          {school.specialty && (
            <div
              className={`specialty-footer ${
                school.specialty
              } flex items-center justify-center gap-1 text-[11px] font-semibold text-center py-1 rounded-b-lg ${
                school.specialty === "hot"
        ...
        <div className="school-content flex flex-col flex-1 overflow-visible">
          ...
          <div className="school-name-container flex items-center mb-3">
            ...
            <div
              className="more-options w-8 h-8 flex items-center justify-center cursor-pointer text-gray-600 rounded-full transition-all duration-200 hover:bg-gray-100 hover:text-gray-700 relative"
            ...
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                ...
                />
                <path
                  d="M12 20C12.5523 20 13 19.5523 13 19C13 18.4477 12.5523 18 12 18C11.4477 18 11 19.4477 11 19C11 19.5523 11.4477 20 12 20Z"
                  stroke="currentColor"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
              ...
              <div
                className={`tooltip absolute top-full right-0 w-44 bg-white rounded-lg shadow-[0_4px_12px_rgba(0,0,0,0.15)] overflow-hidden z-10 transition-all duration-200 ${
                  isTooltipOpen ? "block" : "hidden"
                }`}
              >
                <div className="tooltip-item flex items-center gap-2 px-4 py-2.5 text-sm text-gray-700 cursor-pointer transition-all duration-200 hover:bg-gray-100">
          ...
          <div className="school-footer flex items-center justify-between pt-4 border-t border-gray-200/30">
            <div className="footer-section flex items-center justify-between w-full">
              ...
              />
              <div
                className="status-dropdown relative flex items-center cursor-pointer z-[200]"
                data-school-id={index}
              ...
              >
                <div className="status-indicator flex items-center gap-2 px-3 py-1.5 rounded-md transition-all duration-200 hover:bg-gray-100">
                  ...
                  <span
                    className={`status-text ${statusClass} text-sm font-medium`}
                  >
                    {truncateText(school.status || "Add Status", 12)}
                  </span>
                  <svg
                    className={`status-dropdown-icon ${statusClass} w-3 h-3 ml-2`}
                    width="12"
                    height="12"
                    viewBox="0 0 24 24"
                    fill="none"
                ...
                <div
                  className={`status-options absolute top-full left-0 w-48 bg-white rounded-lg shadow-[0_4px_12px_rgba(0,0,0,0.15)] p-2 mt-1 z-[9999] overflow-hidden max-h-[300px] overflow-y-auto transition-all duration-200 ${
                ...
                >
                  {[
                    ...
                    <div
                      key={status}
                      className="status-option flex items-center gap-2.5 px-4 py-2.5 text-sm text-gray-700 cursor-pointer transition-all duration-200 hover:bg-gray-100"
                      data-status={status}
                      onClick={() => {
                    ...
                    >
                      <div
                        className="status-color w-3 h-3 rounded-full"
