...
export const CardMagazine: React.FC<{
  ...
  return (
    <div className="collections-magazine-card relative z-[1] w-full" data-layout={_layout}>
      ...
      <article
        className="relative h-[400px] w-full overflow-hidden rounded-2xl bg-white shadow-[0_4px_20px_rgba(0,0,0,0.15)]"
      ...
      >
        ...
        {/* Top-right: specialty label — flush corner */}
        {school.specialty ? (
          <div
            className="absolute right-0 top-0 z-[3] flex items-center gap-1 text-[11px] font-medium text-white backdrop-blur-[4px]"
            style={{
        ...
        {/* Content overlay — gradient block above footer */}
        <div
          className="absolute bottom-[90px] left-0 right-0 z-[2] flex h-[180px] flex-col justify-end p-4"
          style={{
            background: "linear-gradient(180deg, transparent 0%, rgba(8, 65, 172, 0.9) 100%)",
          }}
        >
          ...
          <h3 className="mb-1.5 line-clamp-3 text-[18px] font-bold leading-[1.3] text-white">
            {school.name}
          </h3>
          {school.ranking ? (
        ...
        {/* Footer — 90px, dark blue + blur */}
        <footer
          className="absolute bottom-0 left-0 right-0 z-[2] flex h-[90px] items-center justify-between px-4 py-3 backdrop-blur-[8px]"
          style={{
            background: "rgba(8, 65, 172, 0.95)",
            borderRadius: "0 0 16px 16px",
          }}
        >
          {/* Footer left: grade + stats */}
          <div className="flex items-center gap-3" onClick={(e) => e.stopPropagation()}>
            <div
              className="flex h-8 w-8 shrink-0 items-center justify-center rounded-md text-sm font-bold text-white backdrop-blur-[4px]"
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex items-center gap-1.5 text-xs font-medium text-white/90">
                ...
                <button
                  type="button"
                  className="border-none bg-transparent p-0 text-xs font-medium text-white/90 hover:underline"
          ...
          <div className="flex items-center gap-2" onClick={(e) => e.stopPropagation()}>
            ...
            <SchoolCardContextMenu
              ...
              buttonClassName="flex h-8 w-8 items-center justify-center rounded-full bg-white/15 text-white backdrop-blur-[4px] transition-colors hover:bg-white/25"
