...
export interface CollectionsSchool {
  name: string;
  schoolType: string;
  location: string;
  rating: string;
...
// School data
export const schools: CollectionsSchool[] = [
  {
    ...
    reviews: 672,
    dateSaved: "Oct 24, 2025",
    status: "Researching",
    notes: [
      {
        id: 1,
        author: "You",
        content: "My first private note without highlight",
  ...
  // ... (other school objects remain identical to the original JavaScript array)
  {
    ...
    reviews: 845,
    dateSaved: "Sep 15, 2025",
    status: "Researching",
    notes: [
      {
        id: 1,
        author: "You",
        content: "Great campus, need to check their STEM program",
      ...
      },
      {
        id: 2,
        author: "You",
        content: "Meeting with admissions on Dec 5th",
  ...
  },
  {
    ...
    reviews: 957,
    dateSaved: "Nov 2, 2025",
    status: "Applied",
    notes: [
      {
        id: 1,
        author: "You",
        content: "Need to check financial aid options",
      ...
      },
      {
        id: 2,
        author: "You",
        content: "Virtual tour scheduled for next week",
      ...
      },
      {
        id: 3,
        author: "You",
        content: "Application deadline is Dec 15th",
  ...
  },
  {
    ...
    specialty: "",
    description:
      "University of Chicago is known for its rigorous academic program, intellectual culture, and emphasis on critical thinking. The Core curriculum provides a strong interdisciplinary foundation.",
    reviews: 682,
  ...
  },
  {
    ...
    specialty: "hot",
    description:
      "Yale offers an exceptional liberal arts education with a strong emphasis on undergraduate teaching. The residential college system creates a supportive community environment.",
    reviews: 724,
    dateSaved: "Sep 28, 2025",
    status: "Accepted",
    notes: [
      {
        id: 1,
        author: "You",
        content: "Accepted with merit scholarship! Need to respond by May 1.",
        timestamp: "Yesterday",
        time: "19:05",
      },
    ],
...
// Truncate to first N words + ellipsis (e.g. for Grid layout titles)
export const truncateWords = (text: string | undefined, maxWords = 3): string => {
  if (!text) return "";
...
// Rating Checkmarks Component
export const RatingCheckmarks: React.FC<{
  rating: number;
  ...
  for (let i = 1; i <= 5; i++) {
    checkmarks.push(
      <svg
        key={i}
        className={`w-5 h-5 mr-1 cursor-pointer ${i <= rating ? "active" : ""}`}
        preserveAspectRatio="xMidYMid meet"
        xmlns="http://www.w3.org/2000/svg"
        version="1.1"
        viewBox="0 0 24 24"
        fill={i <= rating ? "#07bc44" : "#bcc5d3"}
        data-rating={i}
        onClick={() => onRatingChange(i <= rating && rating === 1 ? 0 : i)}
      >
        <path
          fillRule="nonzero"
  ...
  return <div className="flex items-center">{checkmarks}</div>;
};
...
export const SchoolCard: React.FC<{
  ...
  return (
    ...
    >
      ...
      <div className="school-footer flex items-center justify-between h-[54px] px-4 border-t border-green-500/10 bg-white relative z-20">
        ...
        />
        <div className="notes-count flex items-center gap-1.5 text-xs text-gray-600">
          <svg
