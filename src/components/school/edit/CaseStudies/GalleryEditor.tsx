    ...
    <div className="bg-[#f8f9fa] p-5 rounded-lg">
      ...
      <div className="grid grid-cols-4 max-md:grid-cols-2 gap-3 mb-4">
        {formData.gallery.map((image, index) => (
          <div
            key={index}
            className="relative pt-[75%] rounded-lg overflow-hidden border border-theme"
          >
            <img
              src={image}
              alt="Gallery Image"
        ...
        <div
          ...
          className="relative pt-[75%] rounded-lg border border-dashed border-theme bg-[#f5f5f5] cursor-pointer hover:bg-[#eee] transition-colors"
        >
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 text-default">
