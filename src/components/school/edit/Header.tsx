        ...
        <div className="relative mx-auto flex justify-between rounded-lg pb-3">
          ...
          <div className="flex items-start gap-4">
            <div className="group relative">
              <button className="flex items-center gap-2 rounded-lg border border-[#e0e0e0] bg-white px-4 py-2 text-sm font-medium text-[#1B1B1B] transition-all duration-200 hover:border-[#ccc] hover:bg-[#f8f8f8]">
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 24 24"
