    ...
    <>
      ...
      <div className={`drawer ${isOpen ? "active" : ""}`}>
        <div className="actions-drawer-header">
          <div className="actions-drawer-title">Review Actions</div>
          <button
            type="button"
        ...
        <div className="actions-drawer-content">
          ...
          >
            ...
            <span className="action-item-text">View Review</span>
          </button>
          ...
          {review.reply && (
            <>
              ...
              >
                ...
                <span className="action-item-text">Delete Reply</span>
              </button>
            </>
          )}
        </div>
