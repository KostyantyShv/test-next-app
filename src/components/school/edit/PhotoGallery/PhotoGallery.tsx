...
export default function PhotoGallery() {
  ...
  type MobileGalleryRowProps = {
    item: GalleryItemType;
    onTogglePin: (id: number) => void;
    onEdit: (id: number) => void;
  };

  const MobileSortableGalleryRow = ({ item, onTogglePin, onEdit }: MobileGalleryRowProps) => {
    const {
      attributes,
      listeners,
      setNodeRef,
      ...
      <>
        ...
        {isModalOpen && (
          <MobileDrawer
            ...
            title={currentEditId ? "Edit Photo Details" : "Add Photo"}
