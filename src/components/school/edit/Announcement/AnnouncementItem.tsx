...
export default function AnnouncementItem({
  ...
  return (
    ...
    >
        ...
        <div className="flex-1">
          <div className="flex justify-between items-start mb-2">
            ...
            <div className="flex gap-3 items-center">
              ...
              <button
                className="w-9 h-9 max-md:hidden rounded-full border border-[#E5E5E5] bg-white flex items-center justify-center hover:bg-[#F8F9FA]"
      ...
      <div className="max-md:flex hidden justify-end w-full gap-2">
        <button
          className="w-9 h-9 flex rounded-full border border-[#E5E5E5] bg-white items-center justify-center hover:bg-[#F8F9FA]"
          onClick={() => onTogglePin(announcement.id)}
        >
          <svg viewBox="0 0 20 20" fill="none" width="20" height="20">
            <path
