...
export default function AnnouncementModal({
  ...
  return (
    <div
      className="fixed inset-0 bg-[rgba(0,0,0,0.5)] flex items-center justify-center z-[1000]"
      onClick={(e) => e.target === e.currentTarget && onClose()}
    >
      <div className="bg-white rounded-xl w-full max-w-[600px] max-h-[90vh] overflow-y-auto shadow-[0_4px_24px_rgba(0,0,0,0.1)]">
        <div className="flex justify-between items-center p-6 border-b border-[#E5E5E5]">
          ...
          >
            <svg fill="none" viewBox="0 0 12 12" width="12" height="12">
              <path
                fill="#646464"
                d="M7.46875 6L10.8438 2.65625C11.0312 2.46875 11.0312 2.125 10.8438 1.9375L10.0625 1.15625C9.875 0.96875 9.53125 0.96875 9.34375 1.15625L6 4.53125L2.625 1.15625C2.4375 0.96875 2.09375 0.96875 1.90625 1.15625L1.125 1.9375C0.9375 2.125 0.9375 2.46875 1.125 2.65625L4.5 6L1.125 9.375C0.9375 9.5625 0.9375 9.90625 1.125 10.0938L1.90625  Restrictions: None"
              />
              <path
                fill="#646464"
        ...
        <div className="flex justify-between items-center p-6 border-t border-[#E5E5E5]">
          <button
            className="flex items-center gap-2 text-[#f93a37] bg-none border-none cursor-pointer text-sm"
            onClick={onDelete}
          >
            <svg
              width="20"
          ...
          <div className="flex gap-3">
            <button
              type="button"
              className="bg-[#F8F9FA] border border-[#E5E5E5] text-[#4A4A4A] px-6 py-3 rounded-lg font-semibold text-sm hover:opacity-90"
              onClick={onClose}
            >
              Cancel
            </button>
