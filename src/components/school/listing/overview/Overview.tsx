...
export default function Overview({ id }: { id: string }) {
  ...
  return (
    <>
      <div
        id={id}
        className="flex w-full justify-center text-[#333] my-cardMargin min-h-screen"
      >
        <div className="w-full max-w-full flex justify-center">
          <div className="w-full max-w-full bg-cardBackground rounded-cardBorderRadius p-cardPadding shadow-cardShadow">
            ...
            <div className="bg-[#EBFCF4] rounded-lg p-6 mb-8 relative">
              <div className="text-[#089E68] font-semibold mb-3 text-sm">
                About
              </div>
              <div
              ...
              >
                ...
                academic excellence meets real-world opportunity. Founded in
                1965, we`ve been at the forefront of innovative education for
                over half a century. Our campus combines state-of-the-art
                facilities with a rich tradition of academic achievement and
                cultural diversity. We offer a comprehensive range of
                undergraduate and graduate programs across various disciplines,
                from Business and Engineering to Arts and Sciences. Our
                dedicated faculty members are leading experts in their fields,
                committed to providing students with an engaging and challenging
                educational experience. With small class sizes and a
                student-to-faculty ratio of 15:1, we ensure personalized
                attention and meaningful interactions between students and
                professors. The campus spans 200 acres of beautiful grounds,
                featuring modern academic buildings, research centers, student
                housing, recreational facilities, and a vibrant student center.
                Our location in the heart of the city provides unique
                opportunities for internships, research collaborations, and
                career development.
              </div>
              <button
            ...
            <div className="my-8">
              ...
              >
                ...
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                  <path
                    d={
                      arePointsExpanded ? "M18 15L12 9L6 15" : "M6 9L12 15L18 9"
                    }
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
              ...
              <div className="flex gap-5">
                ...
                <div>
                  <div className="italic text-[#444] leading-6 mb-3 text-sm">
                    ...
                    that the apps ability to suggest kindred interests opens up
