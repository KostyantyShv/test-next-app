...
const StudentsModalContent: React.FC<{ closeModal: () => void }> = ({
  ...
  return (
    <div className="relative w-full bg-white rounded-xl px-5 animate-[fadeIn_0.3s_ease]">
      <div className="sticky top-0 flex items-center justify-between h-fit bg-white z-50 py-5">
      ...
      <div className="mb-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
          <div className="md:pr-8 md:border-r max-md:pb-8 max-md:border-b border-[rgba(0,0,0,0.1)]">
            <div className="text-[#1B1B1B] text-[48px] font-bold mb-6">335</div>
          ...
          <div className="md:pl-8">
            <h3 className="text-[#4A4A4A] text-[15px] font-medium mb-6 max-md:pt-8">
              Student Diversity
            </h3>
      ...
      <div className="mt-12 pt-12 border-t border-[rgba(0,0,0,0.1)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
          <div className="md:pr-8 md:border-r max-md:border-b max-md:mb-8 border-[rgba(0,0,0,0.1)]">
            {[
              {
                percentage: 88,
              ...
              >
                ...
                <div className="flex items-center gap-6 mb-4">
                  ...
                  <div className="text-[#1B1B1B] text-[36px] font-bold leading-none">
                    {poll.percentage}
                    <span className="text-[#666] text-lg font-semibold">%</span>
                  </div>
                </div>
          ...
          <div className="md:pl-8 max-md:bg-[#FAFAFA] rounded-xl max-md:p-4">
            <div className="flex items-center gap-2 mb-6">
