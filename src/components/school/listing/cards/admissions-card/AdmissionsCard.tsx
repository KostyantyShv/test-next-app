          ...
          <div className="flex-1 mb-6 md:mb-0">
            <div className="flex items-center text-[#4A4A4A] text-[16px] mb-3 tracking-[0.2px] font-normal relative">
              ...
              <div className="relative inline-block ml-2 group">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 bg-[#1B1B1B] text-white px-3 py-2 rounded text-[13px] leading-[1.4] w-[280px] text-center mb-2 z-[100] hidden group-hover:block pointer-events-none">
                  Deadline for application submissions. Please contact the school for more details.
                  <div className="absolute top-full left-1/2 -translate-x-1/2 border-[6px] border-solid border-[#1B1B1B] border-b-transparent border-l-transparent border-r-transparent"></div>
                </div>
              </div>
            </div>
