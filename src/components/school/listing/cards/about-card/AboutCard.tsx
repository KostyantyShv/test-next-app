...
const AboutPage: React.FC<{ id: string }> = ({ id }) => {
  ...
  return (
    <div id={id} className="flex justify-center my-cardMargin">
      <div className="w-full max-w-[875px] bg-cardBackground rounded-cardBorderRadius shadow-cardShadow max-md:p-4 p-cardPadding  md:py-cardPadding">
        {/* Profile Header */}
        <div className="flex flex-col md:flex-row gap-6 mb-8 items-center">
          <Image
            ...
            width={120}
            height={120}
            className="rounded-full object-cover border-4 border-white shadow-[0_2px_8px_rgba(0,0,0,0.1)] w-[100px] h-[100px] md:w-[120px] md:h-[120px]"
          />
          <div className="flex-1 text-center md:text-left">
            <h1 className="text-2xl md:text-3xl font-semibold text-[#464646] mb-2">
              Lincoln Academy
            </h1>
            <div className="flex flex-col md:flex-row flex-wrap gap-3 mb-4 items-center justify-center md:justify-start">
              {[
        ...
        {/* Info Grid */}
        <div className="max-md:border max-md:p-4 max-md:rounded-cardBorderRadius">
          <h1 className="hidden max-md:block max-md:mb-2 font-bold">
            Social & Links
          </h1>
          <div className="grid grid-cols-2 gap-6 mb-8">
            {[
              { icon: "clock", label: "Joined", value: "Dec 15, 2024" },
              { icon: "location", label: "Location", value: "Boston, MA" },
              { icon: "website", label: "Website", value: "www.example.com" },
                ...
                <div className="w-8 h-8 bg-[#F8F9FD] rounded-lg flex items-center justify-center text-[#4A4A4A]">
                  ...
                  {field.icon === "phone" && (
                    <svg viewBox="0 0 20 20" width="20" height="20">
                      <path
                        fill="currentColor"
                        d="M15.833 14.167l-2.5-.833a.833.833 0 00-.833.167l-1.667 1.666a10 10 0 01-5-5L7.5 8.333a.833.833 0 00.167-.833l-.834-2.5a.833.833 0 00-.666-.583L3.333 4.167a.833.833 0 00-.916.666A13.333 13.333 0 0015.25 17.667a.833.833 0 00.667-.917l-.25-2.833a.833.833 0 00-.584-.666z"
                      />
                    </svg>
                  )}
                </div>
            ...
            {[
              {
                ...
                svg: (
                  <svg viewBox="0 0 20 20" width="20" height="20">
                    <path
                      fill="currentColor"
                      d="M14.074 3.75h2.172l-4.746 5.295L17.083 16.25h-4.37l-3.425-4.37-3.918 4.37H3.197l5.076-5.663L2.917 3.75h4.482l3.095 3.994L14.074 3.75zm-1.257 11.25h1.2l-7.75-8.75h-1.3l7.85 8.75z"
                    />
                  </svg>
                ),
              },
              ...
              <a
                key={index}
                href="#"
                className="social-link w-10 h-10 rounded-lg flex items-center justify-center bg-[#F8F9FD] text-[#4A4A4A] transition-all duration-200 hover:bg-[#EBFCF4] hover:text-[#016853] hover:-translate-y-0.5 relative"
              ...
              >
                {social.svg}
                <span
                  className={`tooltip absolute bottom-full left-1/2 -translate-x-1/2 bg-[rgba(0,0,0,0.8)] text-white px-2 py-1 rounded text-xs whitespace-nowrap transition-all duration-200 mb-2 ${
                    tooltipStates[index]
                      ? "opacity-100 visible"
                      : "opacity-0 invisible"
                  }`}
          ...
          <div className="flex flex-wrap gap-2 mb-3">
            {[
              ...
              <Image
                ...
                width={40}
                height={40}
                className="avatar rounded-full object-cover border-2 border-white shadow-[0_2px_4px_rgba(0,0,0,0.1)] transition-transform duration-200 w-10 h-10 md:w-10 md:h-10 hover:scale-110 hover:z-10"
              />
            ))}
          </div>
          <a
        ...
        {/* Tags Section */}
        <div className="mb-8 max-md:border rounded-cardBorderRadius max-md:p-4 max-md:mt-4">
