...
export const MobileDrawerIcons = {
    Options: () => (
    ...
    Compare: () => (
        <svg fill="none" viewBox="0 0 18 18" className="w-[22px] h-[22px] text-[#4A4A4A]">
    ...
    ViewListing: () => (
        <svg viewBox="0 0 20 20" fill="none" className="w-[22px] h-[22px] text-[#4A4A4A]">
    ...
    Review: () => (
        <svg fill="currentColor" viewBox="0 0 24 24" className="w-[22px] h-[22px] text-[#4A4A4A]">
    ...
    Monitor: () => (
        <svg viewBox="0 0 16 16" strokeLinejoin="round" className="w-[22px] h-[22px] text-[#4A4A4A]">
    ...
    Share: () => (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="w-[22px] h-[22px] text-[#4A4A4A]">
    ...
    AddTo: () => (
        <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18" className="text-[#4A4A4A] w-[22px] h-[22px]">
    ...
    MoveTo: () => (
        <svg strokeLinejoin="round" strokeLinecap="round" strokeWidth="1.8" stroke="currentColor" fill="none" viewBox="0 0 24 24" className="w-[22px] h-[22px] text-[#4A4A4A]">
    ...
    NewAnnouncement: () => (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[22px] h-[22px] text-[#4A4A4A]">
            <path d="M2 6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 6v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6zm3.519 0L12 11.671 18.481 6H5.52zM20 7.329l-7.341 6.424a1 1 0 0 1-1.318 0L4 7.329V18h16V7.329z" fill="currentColor"></path>
        </svg>
    ),
    ViewAnalytics: () => (
        <svg fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-[22px] h-[22px] text-[#4A4A4A]">
            <path fill="currentColor" d="M4 4C4 3.44772 4.44772 3 5 3H19C19.5523 3 20 3.44772 20 4V20C20 20.5523 19.5523 21 19 21H5C4.44772 21 4 20.5523 4 20V4ZM6.5 18.5H8V11.5H6.5V18.5ZM10.5 18.5H12V8.5H10.5V18.5ZM14.5 18.5H16V14H14.5V18.5Z" clipRule="evenodd" fillRule="evenodd"></path>
        </svg>
    ),
    ViewReports: () => (
        <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-[22px] h-[22px] text-[#4A4A4A]">
    ...
    Arrow: () => (
        <svg className="w-5 h-5 text-[#5F5F5F]" viewBox="0 0 24 24">
            <path fill="currentColor" d="M8.59,16.58L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.58Z" />
        </svg>
    ),
    NestedFavorites: () => (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-6 h-6 text-[#4A4A4A]">
    ...
    Check: () => (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5 h-5 text-[#089E68] stroke-[2.5]">
            <path d="M5 13l4 4L19 7" />
        </svg>
    ),
    Remove: () => (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5 h-5 text-[#4A4A4A]">
