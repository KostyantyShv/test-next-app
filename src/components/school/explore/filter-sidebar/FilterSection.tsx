...
export const FilterSection: React.FC<FilterSectionProps> = ({
  ...
  return (
    <div
      className="mb-6 pb-4 border-b border-[rgba(0,0,0,0.1)]"
    ...
    >
      ...
      >
        <h3 className="text-[15px] font-medium text-bold-text m-0 tracking-tight flex items-center">
          {title}
        ...
        <svg
          className={`w-5 h-5 text-subtle-text transition-transform duration-300 ${
