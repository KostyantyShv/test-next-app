    ...
    <>
      <div className="w-full mb-5 bg-white p-4 md:px-8 rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.05)] border border-[rgba(0,0,0,0.1)]">
        <div className="flex items-center justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-3 flex-wrap flex-1">
            ...
            >
              ...
              <span className="filter-count-badge hidden bg-gradeBadge text-white w-5 h-5 rounded-full text-xs font-medium flex items-center justify-center">
                0
              </span>
              Filters
            </button>
            ...
            <button
              className="reset-all-button hidden items-center gap-1.5 bg-transparent border-none text-textDefault text-xs cursor-pointer px-2 py-1 rounded hover:bg-[rgba(0,0,0,0.05)] transition-all"
              id="resetAllBtn"
            >
              <svg
                fill="none"
        ...
        <div className="active-filters-bar mt-2.5 flex flex-wrap gap-2 items-center">
          <span className="active-filter-label hidden text-sm font-medium text-textDefault">
            Active Filters:
          </span>
        </div>
      </div>
