...
const MainContent: React.FC<MainContentProps> = ({
  ...
  return (
    <div className="w-full bg-transparent md:bg-[var(--surface-color)] rounded-none border-0 shadow-none md:rounded-xl md:border md:border-[var(--border-color)] md:shadow-[0_2px_12px_var(--shadow-color)] overflow-visible">
      <Header
