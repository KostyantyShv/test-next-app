...
const ConnectionsGrid: React.FC = () => {
  return (
    <div className={`${inter.className} text-[#4A4A4A]`}>
          ...
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-lg font-semibold text-[#464646]">4 Followers</h2>
            <div className="text-sm text-[#6F767E]">
              View: <span className="cursor-pointer text-[#016853] font-medium">Followers</span> • <span className="cursor-pointer hover:underline">Following</span>
            </div>
          </div>
  ...
  <div className="flex items-center gap-1 relative group">
    <span className="flex items-center gap-1 font-medium text-[#464646]">
      <span className="w-4 h-4 flex items-center justify-center">{ICONS.location}</span>
      {follower.location}
    </span>
  ...
  <div className="flex items-center gap-1 relative group">
    <span className="flex items-center gap-1 font-medium text-[#464646]">
      <span className="w-4 h-4 flex items-center justify-center">{ICONS.following}</span>
      {follower.following}
    </span>
    <div className="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 bg-black text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">
      Following
  ...
  <div className="flex items-center gap-1 relative group">
    <span className="flex items-center gap-1 font-medium text-[#464646]">
      <span className="w-4 h-4 flex items-center justify-center">{ICONS.reviews}</span>
      {follower.reviews}
    </span>
    <div className="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 bg-black text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">
      Reviews
