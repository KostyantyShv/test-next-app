...
`;
  ...
  const SectionWrapper = ({ children, isLast = false }: { children: React.ReactNode; isLast?: boolean }) => (
    <div className={`bg-white rounded-xl md:rounded-none border border-[#E5E7EB] mb-4 md:mb-0 md:border-0 md:border-b ${isLast ? 'md:border-b-0' : 'md:border-b'} md:shadow-none shadow-[0_1px_3px_rgba(0,0,0,0.1)]`}>
      {children}
    </div>
  );

  return (
    <aside className="lg:bg-white lg:rounded-2xl lg:border lg:border-[#E5E7EB] lg:overflow-hidden lg:h-fit lg:shadow-[0_1px_3px_rgba(0,0,0,0.1)]">
      <div className="flex flex-col lg:flex-col px-4 md:px-0">
        {/* Published Content Section */}
        <SectionWrapper>
          <div className="p-4 md:p-6">
            <h2 className="flex items-center justify-between text-[15px] md:text-base font-semibold md:font-semibold mb-4 text-[#464646]">
              Published Content
            </h2>
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-3">
                <svg
                  ...
                  className="w-[18px] h-[18px] md:w-5 md:h-5 text-[#4F4F4F]"
                >
                  <path
                    fill="currentColor"
                ...
                <span className="text-[13px] md:text-sm text-[#1A1D1F]">25 Listings</span>
              </div>
              <div className="flex items-center gap-3">
                <svg
                  strokeLinejoin="round"
                ...
                <span className="text-[13px] md:text-sm text-[#1A1D1F]">9 Offers</span>
              </div>
              <div className="flex items-center gap-3">
                <svg
                  fill="currentColor"
                ...
                <span className="text-[13px] md:text-sm text-[#1A1D1F]">
        ...
        <SectionWrapper>
          <div className="p-4 md:p-6">
            ...
            <div className="flex gap-3 md:gap-4 flex-wrap">
              <a
                href="#"
                className="w-8 h-8 md:w-8 md:h-8 flex items-center justify-center bg-[#F5F5F7] rounded-md md:rounded-md cursor-pointer hover:bg-[#E5E7EB] transition-colors"
              >
        ...
        <SectionWrapper>
          <div className="p-4 md:p-6">
            <h2 className="flex items-center justify-between text-[15px] md:text-base font-semibold md:font-semibold mb-4 text-[#464646]">
              Followers
              <div className="inline-flex items-center bg-[#f6f8fa] px-3 py-1 rounded-full text-[13px] md:text-sm text-[#1F2328] font-medium">
                111
              </div>
            </h2>
        ...
        <SectionWrapper isLast>
          <div className="p-4 md:p-6">
            ...
            <p
              className={`text-[13px] md:text-sm leading-[1.6] text-[#4F4F4F] ${
                isExpanded ? "" : "max-h-[72px] md:max-h-[120px] overflow-hidden"
              }`}
            >
              {initialAboutText}
            ...
            <button
              ...
              className="inline-flex items-center justify-center mt-3 md:mt-4 px-4 py-2 rounded-md text-xs md:text-sm font-medium text-[#1F2328] bg-[#f6f8fa] gap-2 w-full hover:bg-[#eaecef] transition-colors"
            >
