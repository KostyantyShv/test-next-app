  ...
  return (
    <aside className="bg-white rounded-2xl border border-[#E5E7EB] overflow-hidden h-fit shadow-[0_1px_3px_rgba(0,0,0,0.1)]">
      ...
      <div className="p-6 border-b border-[#E5E7EB]">
        <h2 className="flex items-center gap-3 text-base font-semibold mb-4">
          Published Content
        </h2>
      ...
      <div className="p-6 border-b border-[#E5E7EB]">
        ...
        <div className="flex flex-wrap gap-2 mb-3">
          ...
          />
          <img
            src="https://i.ibb.co/mFj8fCs/AVATAR-couponcodefinder.jpg"
            alt="Follower"
            className="w-8 h-8 rounded-full object-cover border-2 border-white"
          />
          <img
        ...
        <a
          href="#"
          className="text-[#346DC2] text-xs font-medium hover:underline"
        >
          +97 followers
        </a>
      </div>
      ...
      <div className="p-6">
        ...
        <button
          ...
          className="text-[#016853] text-sm font-medium hover:underline"
        >
