...
>(
  (
    ...
    const baseStyles =
      "w-full p-2.5 border border-border-color rounded bg-input-bg text-text-color focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors";
    const readOnlyStyles =
      readOnly || disabled
        ? "bg-readonly-bg cursor-not-allowed opacity-80"
        : "";
