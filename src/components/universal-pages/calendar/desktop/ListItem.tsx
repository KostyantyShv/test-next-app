    ...
    >
      ...
      >
        ...
        <div
          ...
          className={`list-day cursor-pointer ${
            isCurrent ? "text-[var(--active-green)]" : "text-[var(--text-default)]"
          }`}
      ...
      <div className="list-content flex-1 pl-0 flex flex-col gap-3">
        {events.map((event, index) => (
          <div key={index} className={`list-event-item flex items-center gap-4 py-2 ${event.type} group`}>
            <div
              onClick={() => handleEventClick(event.id)}
              className="list-event-content flex-1 min-w-0 cursor-pointer"
              style={{
            ...
            >
              ...
              <div className="list-event-meta flex items-center gap-2 text-sm text-[var(--subtle-text)]">
                <div className="list-event-time-pill inline-flex items-center gap-1 px-2 py-1 rounded-full hover:bg-[var(--hover-bg)] transition-colors">
                  ...
                  {event.type === "zoom-webinar" && (
                    <svg
                      ...
                      fill="none"
                      viewBox="0 0 38 38"
                      className="text-[var(--event-zoom-webinar)]"
                      style={{ width: "20px", height: "20px" }}
                    >
                      <path
                        strokeLinejoin="round"
                  ...
                  {event.type === "teams-meeting" && (
                    <svg
                      ...
                      fill="none"
                      viewBox="0 0 55 55"
                      className="text-[var(--event-teams)]"
                      style={{ width: "20px", height: "20px" }}
                    >
                      <path
                        fill="currentColor"
                  ...
                  {event.type === "webex-meeting" && (
                    <svg
                      ...
                      fill="none"
                      viewBox="0 0 38 38"
                      className="text-[var(--event-webex)]"
                      style={{ width: "20px", height: "20px" }}
                    >
                      <path
                        strokeLinejoin="round"
                  ...
                  {event.type === "group-session" && (
                    <svg
                      ...
                      fill="none"
                      viewBox="0 0 38 38"
                      className="text-[var(--event-group)]"
                      style={{ width: "20px", height: "20px" }}
                    >
                      <path
                        strokeWidth="0.25"
              ...
              <div className="avatar-group flex mr-1">
                <Image
                  ...
                  height={24}
                  src={event.avatar1}
                  className="avatar w-6 h-6 rounded-full border-2 border-[var(--surface-color)] -ml-2 first:ml-0"
                  alt="Attendee 1"
                />
                <Image
                  width={24}
                  height={24}
                  src={event.avatar2}
                  className="avatar w-6 h-6 rounded-full border-2 border-[var(--surface-color)] -ml-2"
                  alt="Attendee 2"
                />
              </div>
