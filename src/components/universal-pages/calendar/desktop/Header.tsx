export const CalendarHeader: React.FC<{
  ...
  <div className="flex items-center gap-6">
    <button
      className="w-8 h-8 rounded-full flex items-center justify-center bg-transparent hover:bg-[var(--hover-bg)]"
      onClick={onPrevMonth}
      aria-label="Previous month"
    >
      <svg viewBox="0 0 25 40" className="w-6 h-6 fill-[var(--subtle-text)]">
    ...
    <h2 className="text-[20px] font-semibold text-[var(--bold-text)]">
      {currentMonth}
    </h2>
