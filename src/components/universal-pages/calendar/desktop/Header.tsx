export const CalendarHeader: React.FC<{
  ...
  <div className="flex items-center gap-4">
    ...
    <button
      className="w-8 h-8 p-1 rounded-full flex items-center justify-center hover:bg-[#5F63681A] bg-[#f7f7f7] border border-[#E0E0E0]"
      onClick={onPrevMonth}
    >
      <svg viewBox="0 0 25 40" className="w-4 h-4 fill-[#5F6368]">
